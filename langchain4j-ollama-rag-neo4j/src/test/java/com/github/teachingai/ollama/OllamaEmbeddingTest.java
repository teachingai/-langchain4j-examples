...
public class OllamaEmbeddingTest {
    ...
    private static String neo4jBoltUrl = "http://localhost:11434";
    private static String neo4jUsername = "neo4j";
    private static String neo4jPassword = "passwd";
    ...
    public static void main(String[] args) {
        ...
        EmbeddingStore<TextSegment> embeddingStore = Neo4jEmbeddingStore.builder()
                .withBasicAuth(neo4jBoltUrl, neo4jUsername, neo4jPassword)
                .dimension(384)
                .build();
