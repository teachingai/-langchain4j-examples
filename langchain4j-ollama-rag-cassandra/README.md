...
> 基于 [Spring Boot 3.x](https://docs.spring.io/spring-boot/index.html) 、[Spring AI](https://docs.spring.io/langchain4j/reference/index.html)、[Ollama](https://ollama.com/) 和 Cassandra 的 检索增强生成（Retrieval-augmented Generation）功能示例。
